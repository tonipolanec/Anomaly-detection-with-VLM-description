...
_DATASETS = {
    ...
    "polanecad": ["datasets.polanecad", "PolanecADDataset"],
}
    ...
    for dataloader_count, dataloaders in enumerate(list_of_dataloaders):
        ...
        for i, SimpleNet in enumerate(simplenet_list):
            ...
            LOGGER.info(
                ...
                "Testing models ({}/{})".format(i + 1, len(simplenet_list))
            )
            # torch.cuda.empty_cache()
            ...
            if not inference_mode:
                print("\n------------- TRAIN in main.py")
                i_auroc, p_auroc, pro_auroc = SimpleNet.train(dataloaders["training"], dataloaders["testing"], save_segmentation_images)
            else:
                print("\n------------- TEST in main.py")
                i_auroc, p_auroc =  SimpleNet.test(dataloaders["training"], dataloaders["testing"], save_segmentation_images=True)
                pro_auroc = 0
            ...
            result_collect.append(
                {
                    ...
                    "image_auroc": i_auroc, # auroc,
                    "pixel_auroc": p_auroc, # full_pixel_auroc,
            ...
            for key, item in result_collect[-1].items():
                if key != "dataset_name" and key != "anomaly_pixel_auroc":
